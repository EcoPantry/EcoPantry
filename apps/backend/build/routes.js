...
const userController_1 = require("./../src/users/userController");
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const models = {
    "User": {
        "dataType": "refObject",
...
function RegisterRoutes(app) {
    ...
    app.get('/users/:userId', ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController)), ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController.prototype.getUser)), async function UsersController_getUser(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    app.post('/users', ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController)), ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController.prototype.createUser)), async function UsersController_createUser(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
